...
class BertSST2Model(nn.Module):
    ...
    def __init__(self, class_size, pretrained_name='bert-base-chinese'):
        ...
        self.bert = BertModel.from_pretrained(pretrained_name,
                                              return_dict=True)
        self.speakerLSTM = nn.LSTM(768, 256, bidirectional=True, batch_first=True)
        self.answerLSTM = nn.LSTM(768, 256, bidirectional=True, batch_first=True)
    ...
    def forward(self, inputs, cut_list):
        ...
        categories_numberic = self.classifier(person_)
